...
interface SimpanPenggunaModalProps {
  visible: boolean;
  onClose: () => void;
  onConfirm: () => void;
}

export default function SimpanPenggunaModal({ visible, onClose, onConfirm }: SimpanPenggunaModalProps) {
  return (
    <Modal visible={visible} transparent animationType="fade" onRequestClose={onClose}>
      <View style={styles.overlay}>
        <View style={styles.modalCard}>
          ...
          <Text style={styles.title}>Simpan Pengguna</Text>
