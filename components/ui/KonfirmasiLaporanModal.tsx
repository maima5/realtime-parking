...
interface KonfirmasiLaporanModalProps {
  visible: boolean;
  onClose: () => void;
  onConfirm: () => void;
}

export default function KonfirmasiLaporanModal({ visible, onClose, onConfirm }: KonfirmasiLaporanModalProps) {
  return (
    <Modal visible={visible} transparent animationType="fade" onRequestClose={onClose}>
      <View style={styles.overlay}>
        <View style={styles.modalCard}>
          ...
          <Text style={styles.title}>Apakah Sudah{'\n'}Ditindak lanjuti?</Text>
